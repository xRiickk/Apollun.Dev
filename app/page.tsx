    ...
    <main>
      <header className={`navbar ${scrolled ? "scrolled" : ""}`}>
        <div className="navInner">
          <a className="brand" href="#inicio" aria-label="Apollun.Dev — início"><span className="brandMark">A</span>APOLLUN<span>.DEV</span></a>
